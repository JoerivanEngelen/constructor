...
WHITELIST = ["grin", "jetsonconda", "miniconda", "newchan", "env_in_file"]
BLACKLIST = []
        ...
        for fpath in os.listdir(output_dir):
            ...
            if ext == "exe" and os.environ.get("NSIS_USING_LOG_BUILD"):
                ...
                try:
                    log_is_empty = True
                    with open(
                        os.path.join(env_dir, "install.log"), encoding="utf-16-le"
                    ) as f:
                        for line in f:
                            log_is_empty = False
                            if ":error:" in line:
            ...
            if test_errored:
                ...
                if ext == "pkg" and os.environ.get("CI"):
                    ...
                    print("---  LOGS  ---")
                    print(
                        "Tip: Debug locally and check the full logs in the Installer UI"
                    )
